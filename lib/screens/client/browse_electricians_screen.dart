...
class BrowseElectriciansScreen extends StatefulWidget {
  const BrowseElectriciansScreen({super.key});

  @override
  State<BrowseElectriciansScreen> createState() =>
      _BrowseElectriciansScreenState();
}

class _BrowseElectriciansScreenState extends State<BrowseElectriciansScreen> {
        ...
        setState(() {
          _allProviders = providers.map((p) {
            ...
            return {
              ...
              'initials': initials,
              'name': name,
              'specialty': p['serviceType'] ?? p['specialty'] ?? 'Electrician',
  ...
  List<Map<String, dynamic>> get _providers {
    ...
    if (_selectedFilter == 1) {
      ...
      // Nearest: only providers whose service radius covers the client
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text(
                    '${providers.length} electricians found',
                    style: const TextStyle(
                      fontSize: 12,
                      color: AppColors.textSecondary,
                  ...
                  ? const Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            'No electricians registered yet',
                            style: TextStyle(
                              fontSize: 13,
                              color: AppColors.textTertiary,
                            ),
