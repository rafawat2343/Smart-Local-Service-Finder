...
class BrowseCleanersScreen extends StatefulWidget {
  const BrowseCleanersScreen({super.key});

  @override
  State<BrowseCleanersScreen> createState() => _BrowseCleanersScreenState();
}

class _BrowseCleanersScreenState extends State<BrowseCleanersScreen> {
        ...
        setState(() {
          _allProviders = providers.map((p) {
            ...
            return {
              ...
              'initials': initials,
              'name': name,
              'specialty': p['serviceType'] ?? p['specialty'] ?? 'Cleaner',
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text(
                    '${providers.length} cleaners found',
                    style: const TextStyle(
                      fontSize: 12,
                      color: AppColors.textSecondary,
