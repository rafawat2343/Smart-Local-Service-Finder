...
class BrowsePaintersScreen extends StatefulWidget {
  const BrowsePaintersScreen({super.key});

  @override
  State<BrowsePaintersScreen> createState() => _BrowsePaintersScreenState();
}

class _BrowsePaintersScreenState extends State<BrowsePaintersScreen> {
        ...
        setState(() {
          _allProviders = providers.map((p) {
            ...
            return {
              ...
              'initials': initials,
              'name': name,
              'specialty': p['serviceType'] ?? p['specialty'] ?? 'Painter',
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text(
                    '${providers.length} painters found',
                    style: const TextStyle(
                      fontSize: 12,
                      color: AppColors.textSecondary,
